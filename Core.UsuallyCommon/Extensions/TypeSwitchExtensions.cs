...
namespace Core.UsuallyCommon
{
    ...
    public static class TypeSwitchExtensions
    {
        ...
        public static Int32 ToInt32(this object obj)
        {
            ...
            if (obj == null)
                return result;
            Int32.TryParse(obj.ToStringExtension(), out result);
            return result;
        }
        ...
        public static Int64 ToInt64(this object obj)
        {
            ...
            if (obj == null)
                return result;
            Int64.TryParse(obj.ToStringExtension(), out result);
            return result;
        }
        ...
        public static Boolean ToBoolean(this object objects)
        {
            ...
            if (objects != null)
                Boolean.TryParse(objects.ToStringExtension(), out result);
            if (!result)
            {
                result = objects.ToStringExtension().Trim() == "1";
            }
            return result;
        }
